...
############################################################
    ##### Este es el juego definitivo del amor #####
############################################################
...
pygame.display.set_caption("Disparando ❤ con Miguel Sarmiento")

#  Cargar imágenes y escalarlas
player_image = pygame.image.load("juego del amor\miguel_foto.jpg")
player_image = pygame.transform.scale(player_image, (60, 60))

bullet_image = pygame.image.load("juego del amor\corazon_azul.png")
bullet_image = pygame.transform.scale(bullet_image, (50, 50))   

enemy_image = pygame.image.load("juego del amor\Maria_foto.jpg")
enemy_image = pygame.transform.scale(enemy_image, (60, 60))

background_image = pygame.image.load("juego del amor/fondo_amor.jpg")
